...
//import listings from "@/data/listings" sale;
    ...
    useEffect(() => {
      ...
      filteredArrays = [...filteredArrays, filtered];
          ...
          if (yearBuild.length > 0) {
            const filtered = refItems.filter(
              (elm) =>
                elm.year_built >= yearBuild[0] &&
                 elm.year_built <= yearBuild[1]
            );
            filteredArrays = [...filteredArrays, filtered];
          }
  ...
  return (
    <section className="pt0 pb90 bgc-f7">
        <div className="container">
          ...
          <div className="row">
            <FeaturedListings  colstyle ={colstyle}  data={pageItems} listings={listings}/>
          </div>
          {/* End .row */}
