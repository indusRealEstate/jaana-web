...
const SingleAgentCta = ({id, agentInfo}) => {
      ...
      <div className="agent-single d-sm-flex align-items-center">
        <div className="single-img mb30-sm">
          <Image
            ...
            src={`https://toprealtorsdubai.com/api/upload/agents/${agentInfo.agent_image}`}
            alt="agents"
          />
        </div>
        {/* End single image */}
        <div className="single-contant ml30 ml0-xs">
          <h2 className="title mb-0">{agentInfo.agent_name != undefined ?agentInfo.agent_name : ""}</h2>
          {/* <p className="fz15">
          ...
          <div className="agent-meta mb15 d-md-flex align-items-center">
            ...
            <a className="text fz15 pe-2 ps-2 bdrr1" href="tel:971505527479">
              ...
              {agentInfo.agent_mobile != undefined ? agentInfo.agent_mobile : ""}
            </a>
